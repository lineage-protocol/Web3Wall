    ...
    <>
      <div className="animate-background bg-gradient-to-r from-green-300 via-blue-500 to-purple-600 shadow-lg transition bg-[length:400%_400%] [animation-duration:_4s] rounded-lg border border-gray-100 bg-white p-1">
        <div className="rounded-[10px] bg-white p-6">
          ...
          <h3 className="mt-2 text-xl font-medium text-gray-900">Android Not Compatible</h3>

          <p className="mt-2 text-sm/relaxed text-gray-500">Requires Android 10 or later to send push notifications.</p>
        </div>
      </div>
    </>
  )
...
export default AndroidNotMatchModal
